                ...
                <?php if(is_array($info)): foreach($info as $key=>$v): ?><div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        ...
                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="/wei/index.php/Home/Search/detail/goods_id/<?php echo ($v["goods_id"]); ?>">Go to Detail</a>     
                        </div>   
