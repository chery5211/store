...
<div class="main_box">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="<?php echo U('Index/right');?>">首页</a> &raquo; <a href="#">商品管理</a> &raquo; 添加权限
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="" method="post">
            <table class="search_tab">
                <tr>
                    ...
                    <td><a href="<?php echo U('tianjia');?>">添加分类</a></td>
                </tr>
...
<!--                         <th>控制器</th>
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                        ...
                        <td class="tc"><?php echo ($v["cate_id"]); ?></td>
                        <td><?php echo str_repeat('---', $v['cate_level']); echo ($v["cate_name"]); ?></td>
                        <td><?php echo ($v["cate_pid"]); ?></td>
                        <td><?php echo ($v["cate_path"]); ?></td>
                        <td><?php echo ($v["cate_level"]); ?></td>

                        <td>
                            <a href="/wei/index.php/Admin/Cate/update/id/<?php echo ($v["cate_id"]); ?>">修改</a>
                            <a href="/wei/index.php/Admin/Cate/delete/id/<?php echo ($v["cate_id"]); ?>" onclick="return confirmDele()">删除</a>
                        </td>
