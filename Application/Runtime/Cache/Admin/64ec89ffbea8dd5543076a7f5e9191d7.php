...
<div class="main_box">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="<?php echo U('Index/right');?>">首页</a> &raquo; <a href="#">商品管理</a> &raquo; 添加商品
    </div>
    <!--面包屑导航 结束-->
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                        ...
                        <td class="tc"><?php echo ($v["order_id"]); ?></td>
                        <td><?php echo ($v["order_name"]); ?></td>
                        <td><?php echo ($v["order_email"]); ?></td>
                        <td><?php echo ($v["order_tel"]); ?></td>
                        <td><?php echo ($v["order_addr"]); ?></td>
                        <td><?php echo ($v["order_time"]); ?></td>
                        <td><?php echo ($v["order_total"]); ?></td>
 
         
                        <td>
                            <!-- <a href="/wei/index.php/Admin/Order/update/goods_id/<?php echo ($v["goods_id"]); ?>">修改</a> -->
                            <a href="/wei/index.php/Admin/Order/delete/goods_id/<?php echo ($v["goods_id"]); ?>">删除</a>
                        </td>
