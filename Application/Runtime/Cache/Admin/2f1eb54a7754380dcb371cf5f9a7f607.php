...
<div class="main_box">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="<?php echo U('Index/right');?>">首页</a> 
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="" method="post">
            <table class="search_tab">
                <tr>
                    ...
                    <td><a href="<?php echo U('tianjia');?>">添加管理员</a></td>
                </tr>
...
<!--                         <th>控制器</th>
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                        ...
                        <td class="tc"><?php echo ($v["mg_id"]); ?></td>
                        ...
                        <td>
                            <a href="/wei/index.php/Admin/Manager/update/id/<?php echo ($v["mg_id"]); ?>">修改</a>
                            <a href="/wei/index.php/Admin/Manager/delete/id/<?php echo ($v["mg_id"]); ?>" onclick="return confirmDele()">删除</a>
                        </td>
