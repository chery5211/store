...
<div class="main_box">
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="<?php echo U('Index/right');?>">首页</a> &raquo; 
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="" method="post">
            <table class="search_tab">
                <tr>
                    ...
                    <td><a href="<?php echo U('Role/tianjia');?>">添加角色</a></td>
                </tr>
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                        <td class="tc"><?php echo ($v["role_id"]); ?></td>
                        <td><?php echo ($v["role_name"]); ?></td>
                        <td>
                            <a href="/wei/index.php/admin/role/distribute/role_id/<?php echo ($v["role_id"]); ?>">分配权限</a>
                            <a href="/wei/index.php/admin/role/update/id/<?php echo ($v["role_id"]); ?>">修改</a>
                            <a href="/wei/index.php/admin/role/delete/id/<?php echo ($v["role_id"]); ?>"  onclick="return confirmDele()">删除</a>
                        </td>
