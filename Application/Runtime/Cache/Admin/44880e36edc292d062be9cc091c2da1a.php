            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                        ...
                        <td class="tc"><?php echo ($v["goods_id"]); ?></td>
                        <td><?php echo ($v["goods_name"]); ?></td>
                        <td><?php echo ($v["goods_number"]); ?></td>
                        <td><?php echo ($v["goods_view"]); ?></td>
                        <td><?php echo ($v["goods_price"]); ?></td>
                        <td><?php echo ($v["goods_price2"]); ?></td>
 
                        <td><?php echo ($v["goods_create_time"]); ?></td>
                        <td>
                            <a href="/wei/index.php/admin/goods/update/goods_id/<?php echo ($v["goods_id"]); ?>">修改</a>
                            <a href="/wei/index.php/admin/goods/delete/goods_id/<?php echo ($v["goods_id"]); ?>">删除</a>
                        </td>
